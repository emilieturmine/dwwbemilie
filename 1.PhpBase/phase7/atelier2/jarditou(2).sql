...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 22 juil. 2021 à 17:50
...
CREATE TABLE `categories` (
  `cat_id` int UNSIGNED NOT NULL COMMENT 'Clé de la table catégorie',
...
CREATE TABLE `produits` (
  `pro_id` int UNSIGNED NOT NULL COMMENT 'Clé de la table produits',
...
--
ALTER TABLE `categories`
  MODIFY `cat_id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clé de la table catégorie', AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT pour la table `produits`
--
ALTER TABLE `produits`
  MODIFY `pro_id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clé de la table produits', AUTO_INCREMENT=42;
